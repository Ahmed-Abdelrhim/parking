...
window.colors = { solid: { primary: "#7367F0", secondary: "#82868b", success: "#28C76F", info: "#00cfe8", warning: "#FF9F43", danger: "#EA5455", dark: "#4b4b4b", black: "#000", white: "#fff", body: "#f8f8f8" }, light: { primary: "#7367F01a", secondary: "#82868b1a", success: "#28C76F1a", info: "#00cfe81a", warning: "#FF9F431a", danger: "#EA54551a", dark: "#4b4b4b1a" } },
    function(a, e, t) {
        ...
        var s = t("html"),
            ...
            o = "#4e5154",
            r = "../../../app-assets/";
        if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")), t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, { sFilterInput: "form-control", sLengthSelect: "form-select" }), t(a).on("load", (function() {
                var r = !1;
                (n.hasClass("menu-collapsed") || "true" === localStorage.getItem("menuCollapsed")) && (r = !0), t("html").data("textdirection"), setTimeout((function() { s.removeClass("loading").addClass("loaded") }), 1200), t.app.menu.init(r);
                !1 === t.app.nav.initialized && t.app.nav.init({ speed: 300 }), Unison.on("change", (function(a) { t.app.menu.change(r) }));
                [].slice.call(e.querySelectorAll('[data-bs-toggle="tooltip"]')).map((function(a) { return new bootstrap.Tooltip(a) }));
                t('a[data-action="collapse"]').on("click", (function(a) { a.preventDefault(), t(this).closest(".card").children(".card-content").collapse("toggle"), t(this).closest(".card").find('[data-action="collapse"]').toggleClass("rotate") })), t(".touchspin-cart").length > 0 && t(".touchspin-cart").TouchSpin({ buttondown_class: "btn btn-primary", buttonup_class: "btn btn-primary", buttondown_txt: feather.icons.minus.toSvg(), buttonup_txt: feather.icons.plus.toSvg() }), t(".dropdown-notification .dropdown-menu, .dropdown-cart .dropdown-menu").on("click", (function(a) { a.stopPropagation() })), t(".scrollable-container").each((function() { new PerfectScrollbar(t(this)[0], { wheelPropagation: !1 }) })), t('a[data-action="reload"]').on("click", (function() {
                ...
                })), t('a[data-action="close"]').on("click", (function() { t(this).closest(".card").removeClass().slideUp("fast") })), t('.card .heading-elements a[data-action="collapse"]').on("click", (function() {
                ...
                f.length > 0 && f[0].addEventListener("ps-scroll-y", (function() { t(this).find(".ps__thumb-y").position().top > 0 ? t(".shadow-bottom").css("display", "block") : t(".shadow-bottom").css("display", "none") }))
            })), t(e).on("click", ".sidenav-overlay", (function(a) { return t.app.menu.hide(), !1 })), "undefined" != typeof Hammer) {
            var l;
            "rtl" == t("html").data("textdirection") && (l = !0);
            var i = e.querySelector(".drag-target"),
                c = "panright",
                d = "panleft";
            if (!0 === l && (c = "panleft", d = "panright"), t(i).length > 0) new Hammer(i).on(c, (function(a) { if (n.hasClass("vertical-overlay-menu")) return t.app.menu.open(), !1 }));
            setTimeout((function() {
                var a, s = e.querySelector(".main-menu");
                t(s).length > 0 && ((a = new Hammer(s)).get("pan").set({ direction: Hammer.DIRECTION_ALL, threshold: 250 }), a.on(d, (function(a) { if (n.hasClass("vertical-overlay-menu")) return t.app.menu.hide(), !1 })))
            }), 300);
            var h = e.querySelector(".sidenav-overlay");
            if (t(h).length > 0) new Hammer(h).on("tap", (function(a) { if (n.hasClass("vertical-overlay-menu")) return t.app.menu.hide(), !1 }))
        }
        if (t(e).on("click", ".menu-toggle, .modern-nav-toggle", (function(e) { return e.preventDefault(), t.app.menu.toggle(), setTimeout((function() { t(a).trigger("resize") }), 200), t("#collapse-sidebar-switch").length > 0 && setTimeout((function() { n.hasClass("menu-expanded") || n.hasClass("menu-open") ? t("#collapse-sidebar-switch").prop("checked", !1) : t("#collapse-sidebar-switch").prop("checked", !0) }), 50), n.hasClass("menu-expanded") || n.hasClass("menu-open") ? localStorage.setItem("menuCollapsed", !1) : localStorage.setItem("menuCollapsed", !0), !1 })), t(".navigation").find("li").has("ul").addClass("has-sub"), t(a).resize((function() { t.app.menu.manualScroller.updateHeight() })), t("#sidebar-page-navigation").on("click", "a.nav-link", (function(a) {
                a.preventDefault(), a.stopPropagation();
                var e = t(this),
                    s = e.attr("href"),
                    n = t(s).offset().top - 80;
                t("html, body").animate({ scrollTop: n }, 0), setTimeout((function() { e.parent(".nav-item").siblings(".nav-item").children(".nav-link").removeClass("active"), e.addClass("active") }), 100)
        ...
        } else i18next.use(a.i18nextXHRBackend).init({ debug: !1, fallbackLng: "en", backend: { loadPath: r + "data/locales/{{lng}}.json" }, returnObjects: !0 }, (function(a, e) { jqueryI18next.init(i18next, t) })), t(".dropdown-language .dropdown-item").on("click", (function() {
            var a = t(this);
            ...
            i18next.changeLanguage(n, (function(a, e) { t(".main-menu, .horizontal-menu-wrapper").localize() }))
        }));
        ...
        t(".search-list-main").mouseenter((function() { I.update() })), w.on("keyup", (function(a) {
                        ...
                        for (var m = 0; m < a.listItems.length; m++) {
                            if ("laravel" === t("body").attr("data-framework") && (a.listItems[m].url = r + a.listItems[m].url), !0 === n) {
                                ...
                                for (var p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0; v < p.length; v++) {
                                    if (a.listItems[m].name === p[v].firstChild.dataset.bsOriginalTitle) { s = " text-warning"; break }
                                    s = ""
                                }
        ...
        })), t(".scroll-top").on("click",


            (function() { t("html, body").animate({ scrollTop: 0 }, 75) }));
